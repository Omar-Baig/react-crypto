                ...
                <div className="card-wrap">
                    {this.state.currency.map(el => (
                        <div key={el.id} className="card">
                            ...
                            <div className="price price-1h"><span>1H: $</span>{el.percent_change_1h}</div>
                            <div className="price price-24h"><span>24H: $</span>{el.percent_change_24h}</div>
                            <div className="price price-7d"><span>7D: $</span>{el.percent_change_7d}</div>
                        </div>
                    ))}
                </div>
            </div>
